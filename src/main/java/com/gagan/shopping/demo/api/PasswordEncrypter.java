package com.gagan.shopping.demo.api;
...
public class PasswordEncrypter implements DataEncryptor {
    ...
    public PasswordEncrypter(String password) throws InvalidKeySpecException {
